...
public class Consts
{
  ...
  public static enum PurchaseState
  {
    ...
    public static PurchaseState valueOf(int paramInt)
    {
      ...
      for (PurchaseState localPurchaseState = CANCELED; ; localPurchaseState = arrayOfPurchaseState[paramInt])
  ...
  public static enum ResponseCode
  {
    ...
    public static ResponseCode valueOf(int paramInt)
    {
      ...
      for (ResponseCode localResponseCode = RESULT_ERROR; ; localResponseCode = arrayOfResponseCode[paramInt])
 ...
 * Qualified Name:     ru.humantouch.besharp.Consts
