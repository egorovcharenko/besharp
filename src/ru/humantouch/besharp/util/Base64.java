package ru.humantouch.besharp.util;
...
public class Base64
{
    ...
    throws Base64DecoderException
  {
    ...
    {
      i1 = (byte)(0x7F & paramArrayOfByte1[(k + paramInt1)]);
      i2 = paramArrayOfByte2[i1];
      if (i2 >= -5)
      {
        if (i2 < -1)
          break label412;
        ...
        {
          int i5 = paramInt2 - k;
          int i6 = (byte)(0x7F & paramArrayOfByte1[(paramInt1 + (paramInt2 - 1))]);
          if ((m == 0) || (m == 1))
            throw new Base64DecoderException("invalid padding byte '=' at byte offset " + k);
          if (((m == 3) && (i5 > 2)) || ((m == 4) && (i5 > 1)))
            throw new Base64DecoderException("padding byte '=' falsely signals end of encoded value at offset " + k);
          if ((i6 == 61) || (i6 == 10))
            break label409;
        ...
        if (i3 == 4)
        {
          int i4 = j + decode4to3(arrayOfByte2, 0, arrayOfByte1, j, paramArrayOfByte2);
          i3 = 0;
          j = i4;
        }
      }
    ...
    while (true)
    {
      ...
      i = i2;
      break;
      throw new Base64DecoderException("Bad Base64 input character at " + k + ": " + paramArrayOfByte1[(paramInt1 + k)] + "(decimal)");
      (m + 1);
      arrayOfByte2[m] = 61;
      label399: for (int i7 = j + decode4to3(arrayOfByte2, 0, arrayOfByte1, j, paramArrayOfByte2); ; i7 = j)
      {
        byte[] arrayOfByte3 = new byte[i7];
        System.arraycopy(arrayOfByte1, 0, arrayOfByte3, 0, i7);
        return arrayOfByte3;
      }
      label409: break label43;
      label412: i3 = m;
    }
  }
 ...
 * Qualified Name:     ru.humantouch.besharp.util.Base64
